...
private:
  void poseCallback(const turtleclean::PoseConstPtr& pose);
...
Mimic::Mimic()
{
  ...
  pose_sub_ = input_nh.subscribe<turtleclean::Pose>("pose", 1, &Mimic::poseCallback, this);
}

void Mimic::poseCallback(const turtleclean::PoseConstPtr& pose)
{
